...
PageTemplate.Panel = (props: any) => {
    const colSizes: string = "col-12 col-lg-10 offset-lg-1 col-xxl-8 offset-xxl-2 g-5 py-4"
    
    return (
        <div>  {/* Div extra necessária para fixar alterações do display grid. TODO: Revisitar essa área para entender melhor e fazer possiveis melhorias */}
            <div className="row">
